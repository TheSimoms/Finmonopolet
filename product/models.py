...
class Product(models.Model):
    ...
    volume = models.DecimalField(verbose_name='Volume', max_digits=5, decimal_places=2)
    price = models.DecimalField(verbose_name='Price', max_digits=8, decimal_places=2)
    litre_price = models.DecimalField(verbose_name='Price per litre', max_digits=8, decimal_places=2)
    alcohol_price = models.DecimalField(verbose_name='Price per unit of alcohol', max_digits=8, decimal_places=2)

    category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='products')

    fullness = models.IntegerField(verbose_name='Fullness', validators=[MinValueValidator(1), MaxValueValidator(12)],
                                   blank=True, null=True)
    freshness = models.IntegerField(verbose_name='Freshness', validators=[MinValueValidator(1), MaxValueValidator(12)],
                                    blank=True, null=True)
    tannins = models.IntegerField(verbose_name='Tannins', validators=[MinValueValidator(1), MaxValueValidator(12)],
                                  blank=True, null=True)
    bitterness = models.IntegerField(verbose_name='Bitterness',
                                     validators=[MinValueValidator(1), MaxValueValidator(12)], blank=True, null=True)
    sweetness = models.IntegerField(verbose_name='Sweetness', validators=[MinValueValidator(1), MaxValueValidator(12)],
                                    blank=True, null=True)
    ...
    country = models.CharField(verbose_name='Country of origin', max_length=255)
    ...
    vintage = models.IntegerField(verbose_name='Vintage', blank=True, null=True)
    ...
    alcohol = models.DecimalField(verbose_name='Alcohol percentage', max_digits=4, decimal_places=2)
    sugar = models.DecimalField(verbose_name='Grams of sugar per litre', max_digits=5, decimal_places=2,
                                blank=True, null=True)
    acid = models.DecimalField(verbose_name='Grams of acid per litre', max_digits=5, decimal_places=2,
                               blank=True, null=True)

    storage = models.TextField(verbose_name='How to store product', blank=True, null=True)

    producer = models.CharField(verbose_name='Producer', max_length=255, blank=True, null=True)
