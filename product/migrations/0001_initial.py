# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-05-24 15:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_number', models.IntegerField(unique=True, verbose_name='Product ID')),
                ('product_name', models.CharField(max_length=255, verbose_name='Product name')),
                ('url', models.URLField(verbose_name='Product URL')),
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Last updated')),
                ('volume', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Volume')),
                ('price', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='Price')),
                ('litre_price', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='Price per litre')),
                ('alcohol_price', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='Price per unit of alcohol')),
                ...
                ('vintage', models.IntegerField(blank=True, null=True, verbose_name='Vintage')),
                ...
                ('alcohol', models.DecimalField(decimal_places=2, max_digits=4, verbose_name='Alcohol percentage')),
