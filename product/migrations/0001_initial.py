    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('canonical_name', models.CharField(db_index=True, max_length=255, verbose_name='Canonical product name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=255, unique=True, verbose_name='Suits name')),
            ],
        ),
        migrations.AddField(
            model_name='product',
